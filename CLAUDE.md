...
| Un solo mensaje del pasajero con todos los datos, no pregunta-por-pregunta | Flujo paso a paso (una pregunta, una respuesta, repetir) | Menos idas y vueltas. El costo es que el parseo es más difícil (de ahí Gemini + respaldo). |
